...
const HeaderTodo = () => {
  ...
  return (
    <Flex bg="#1C538E" w="100%" h="12%" py="1rem" px="2rem" borderTopRadius="0.9rem" color="white">
      <Flex justify="space-between" align="center" w="100%">
        <Box>
          <Text as="h2" fontWeight="bold" fontSize="1.6rem">{date}</Text>
        </Box>
        <Box>
          <Text as="h3" fontWeight="500">{time}</Text>
        </Box>
      </Flex>
    </Flex>
  )
